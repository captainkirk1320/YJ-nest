...
import { AppNotification, Volunteer } from './types';
...
export default function App() {
  ...
  const [showActivityReport, setShowActivityReport] = useState<{ show: boolean, initialTab: 'Contributions' | 'Hustle' }>({ show: false, initialTab: 'Contributions' });
    ...
    switch (activeTab) {
      case 'Home': return (
        <HomeTab 
          ...
          onViewHustle={() => setShowActivityReport({ show: true, initialTab: 'Hustle' })}
